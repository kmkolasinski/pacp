...
plot "IsingTestChi2D.txt"  u 1:2  w p pt 17 lc -1 lw 2 t "Chi(Metropolis)", \
     "IsingTestChi2D_w.txt"  u 1:2  w p pt 17 lc 2 t "Chi(Wolff)" #, a*(abs(x-Tc)/Tc)**(-gamma) t "0.001|t|^{-7/4}"
