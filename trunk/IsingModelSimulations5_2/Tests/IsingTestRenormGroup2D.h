/* 
 * File:   IsingTestRenormGroup2D.h
 * Author: edyta
 *
 * Created on 22 maj 2014, 02:01
 */

#ifndef ISINGTESTRENORMGROUP2D_H
#define	ISINGTESTRENORMGROUP2D_H

#include "IsingTest.h"

class IsingTestRenormGroup2D : public IsingTest {

   public:
       IsingTestRenormGroup2D():IsingTest(){
       ...
       void run(){
        ...
        Ising2D chain3(chainLength*3,temp,magneticField,initState,maxGdist,maxTsep);   
        chain3.MC_simulation(therm_t,prod_t,measure_f,METHOD_METROPOLIS);
...
//                DATA << SS3[i][k] << " ";
        ...
        DATA.close();
        Ising2D chain1(chainLength,temp,magneticField,initState,maxGdist,maxTsep);   
...
#endif	/* ISINGTESTRENORMGROUP2D_H */
